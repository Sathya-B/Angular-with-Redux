...
namespace JT_Transport.Helper
{
    ...
    public class AmazonHelper
    {
        ...
        public static string GetAmazonS3Object(string bucketName, string objectKey)
        {
            ...
            {
                SL.ServerSideLogger.CreateLog("AmazonHelper", "GetAmazonS3Object", ex.Message);
                return "";
            }
        }
        ...
        public async static Task<bool> UploadImageToS3(IFormFile file, string bucketName, string objectName)
        {
            ...
            {
                SL.ServerSideLogger.CreateLog("AmazonHelper", "UploadImageToS3", ex.Message);
                return false;
            }
        }
    }
