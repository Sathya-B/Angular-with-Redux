...
@Component({
  selector: 'app-tripinfoline',
  templateUrl: './tripinfoline.component.html',
  styleUrls: ['./tripinfoline.component.css']
})
export class TripInfoLineComponent implements OnInit {

  tripData: any;
  modalRef: BsModalRef;
  @select('tripInfoLine') tripInfo;
...
//    this.tripData = new Trip();
  ...
  searchTrips(){
    ...
    this.tripServ.searchTripLineInfo(query);
  }
}
